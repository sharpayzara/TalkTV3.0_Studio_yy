...
public class DLNAVerticalSeekBar extends AbsSeekBar {
	...
	public DLNAVerticalSeekBar(Context context) {
		this(context, null);
	}

	public DLNAVerticalSeekBar(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.seekBarStyle);
	}

	public DLNAVerticalSeekBar(Context context, AttributeSet attrs, int defstyle) {
