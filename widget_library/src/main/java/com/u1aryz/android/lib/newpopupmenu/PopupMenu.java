...
public class PopupMenu {
	...
	public void show(View anchor) {
		...
		Rect anchorRect = new Rect(location[0], location[1], location[0]
				+ anchor.getWidth(), location[0] + anchor.getHeight());
	...
	private void preShow() {
		...
		if (backGroundResId > 0) {
			mPopupWindow.setBackgroundDrawable(mContext.getResources()
	...
	/**
	 * Sets the popup menu header's color
	 * 
	 * @param resId
	 */
	public void setHeaderTitleColorResource(int resId) {
		mHeaderTitleView.setTextColor(mContext.getResources().getColor(resId));
	}

	/**
	 * Sets the popup menu header's background
	 * 
	 * @param resId
	 */
	public void setHeaderBackgroud(int resId) {
		mHeaderTitleView.setBackgroundResource(resId);
	}
	 ...
	 * @param resId
	 */
	public void setItemeColorResource(int resId) {
		itemColor = mContext.getResources().getColor(resId);
	}
	...
	private class MenuItemAdapter extends ArrayAdapter<MenuItem> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			ViewHolder holder;
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.popup_menu_list_item,
						null);
