...
public final class KeyboardHelper {
	 ...
	 * Shortcat for
	 * {@link #hideSoftKeyboard(android.content.Context, android.view.View...)
	 ...
	 * Note: In AndroidManifest corresponding activity should have
	 * <code>android:windowSoftInputMode</code> set to <code>adjustResize</code>
	 * .
	 * 
	 * @param rootView
	 *            should be deepest full screen view, i.e. root of the layout
	 *            passed to Activity.setContentView(...) or view returned by
