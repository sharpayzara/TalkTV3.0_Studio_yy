...
/**
 * 结合viewPager使用 <br>
 * 使用见：https://github.com/astuetz/PagerSlidingTabStrip
 * 
 * @author suma-hpb
 * 
 */
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int redTipPos;
	private CircleImageView redTip;
	...
	/**
	 * show/hide red tip on the position
	 * 
	 * @param index
	 *            position
	 * @param show
	 *            true-show red tip
	 */
	public void changeRedTip(int index, boolean show) {
		View tab = tabsContainer.getChildAt(index);
		CircleImageView tipView = (CircleImageView) tab
				.findViewById(R.id.tab_tip);
