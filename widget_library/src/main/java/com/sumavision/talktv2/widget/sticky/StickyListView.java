package com.sumavision.talktv2.widget.sticky;
...
import com.sumavision.talktv2.widget.sticky.WrapperViewList.LifeCycleListener;
...
public class StickyListView extends FrameLayout {
    ...
    public interface OnHeaderClickListener {
        public void onHeaderClick(StickyListView l, View header,
    ...
    public interface OnStickyHeaderOffsetChangedListener {
         ...
         */
        public void onStickyHeaderOffsetChanged(StickyListView l, View header, int offset);
    }
    ...
    private class AdapterWrapperHeaderClickHandler implements
        ...
        public void onHeaderClick(View header, int itemPosition, long headerId) {
            mOnHeaderClickListener.onHeaderClick(
                    StickyListView.this, header, itemPosition,
                    headerId, false);
        }
