...
final class M3uConstants {
    ...
    static class Patterns {
        ...
        final static Pattern EXTINF = Pattern.compile(tagPattern(M3uConstants.EXTINF) + "\\s*(-1|(\\d+(\\.\\d+)?)*)\\s*(?:,((.*)))?");
        ...
        final static Pattern EXT_X_KEY = Pattern.compile(tagPattern(M3uConstants.EXT_X_KEY) + "METHOD=([0-9A-Za-z\\-]*)(,URI=\"(([^\\\\\"]*.*))\")?(,IV=([0-9A-Za-z]*))?");
