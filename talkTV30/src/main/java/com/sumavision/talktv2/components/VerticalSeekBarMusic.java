...
public class VerticalSeekBarMusic extends AbsSeekBar {

	private int height = -1;
	private int width = -1;

	public interface OnSeekBarChangeListener {
		public void onProgressChanged(VerticalSeekBarMusic vBar, int progress,
				boolean fromUser);

		public void onStartTrackingTouch(VerticalSeekBarMusic vBar);

		public void onStopTrackingTouch(VerticalSeekBarMusic vBar);
	}

	private OnSeekBarChangeListener mOnSeekBarChangeListener;

	public VerticalSeekBarMusic(Context context) {
		this(context, null);
	}

	public VerticalSeekBarMusic(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.seekBarStyle);
		width = (int) (context.getResources().getDisplayMetrics().density * 15);
	}
