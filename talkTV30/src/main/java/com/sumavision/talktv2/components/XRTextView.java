...
public class XRTextView extends TextView{
	...
	public XRTextView(Context context, AttributeSet attrs) {
		...
		textSize = attrs.getAttributeIntValue(namespace, "textSize", 14);//字体大小
		textSize = sp2px(context, textSize);
		textColor = attrs.getAttributeIntValue(namespace, "textColor",Color.parseColor("#555555"));//字体颜色
		...
		paddingLeft = sp2px(context, paddingLeft);
		paddingBottom= sp2px(context, paddingBottom);
		paddingTop= sp2px(context, paddingTop);
		paddingRight= sp2px(context, paddingRight);
		marginBottom = sp2px(context, marginBottom);
		marginTop = sp2px(context, marginTop);
		marginRight = sp2px(context, marginRight);
		marginLeft = sp2px(context, marginLeft);
